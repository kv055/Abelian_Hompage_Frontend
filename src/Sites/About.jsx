            ...
            <Header></Header>
                ...
                <div className='bg-violet-200'>
                    ...
                    <div className='flex items-center justify-center flex-wrap'>
                        ...
                        <div className='flex-col m-5 md:m-10 md:w-2/3 py-10'>
                            <div className='flex flex-col xl:flex-row justify-evenly items-baseline'>
                                <h5 className='RobotoCondensed text-center  text-indigo-700 font-extrabold px-10 tracking-widest md:text-3xl'>William Godfrey</h5>
                                ...
                                <a href = "mailto: william.godfrey@abelian.capital" className='RobotoCondensed text-center px-10'>Send Email</a>
                            </div>
                            <div className='flex flex-col xl:flex-row'>
                                ...
                                />
                                <p className='m-10 RobotoCondensed bg-indigo-50 p-10 leading-8'>
                        ...
                        <div className='flex-col m-5 md:m-10 md:w-2/3 py-10'>
                            <div className='flex flex-col xl:flex-row justify-evenly items-baseline'>
                                <h5 className='RobotoCondensed text-center  text-indigo-700 font-extrabold px-10 tracking-widest md:text-3xl'>Kilian Voss</h5>
                                ...
                                <a href = "mailto: kilian.voss@abelian.capital" className='RobotoCondensed text-center px-10'>Send Email</a>
                            </div>
                        ...
                        <div className='flex-col m-5 md:m-10 md:w-2/3 py-10'>
                            <div className='flex flex-col xl:flex-row justify-evenly items-baseline'>
                                <h5 className='RobotoCondensed text-center  text-indigo-700 font-extrabold px-10 tracking-widest md:text-3xl'>Lachlan Steele</h5>
                                ...
                                <a href = "mailto: lachlan.steele@abelian.capital" className='RobotoCondensed text-center px-10'>Send Email</a>
                            </div>
                            <div className='flex flex-col xl:flex-row'>
                                <img 
                                    src={Lachlan_Photo} 
                        ...
                        <div className='flex-col m-5 md:m-10 md:w-2/3 py-10'>
                            <div className='flex flex-col xl:flex-row justify-evenly items-baseline'>
                                <h5 className='RobotoCondensed text-center  text-indigo-700 font-extrabold px-10 tracking-widest md:text-3xl'>Aleks Lyubinov</h5>
                                ...
                                <a href = "mailto: aleks.lyubinov@abelian.capital" className='RobotoCondensed text-center px-10'>Send Email</a>
                            </div>
                            ...
                            <div className='flex flex-col xl:flex-row-reverse'>
                                ...
                                <p className='m-10 RobotoCondensed bg-indigo-50 p-10 leading-8'>
                                    ...
                                    Aleks is a dedicated and detail-oriented individual who is always looking for ways to improve our algorithms and models. He has a passion for exploring the latest developments in the field of machine learning and is constantly learning and growing his skill set. 
                                    {/* His expertise and knowledge are critical to our success in making data-driven decisions and providing top-notch asset management services to our clients. */}
                                </p>   
                            </div>
                        ...
                        <div className='flex-col m-5 md:m-10 md:w-2/3 py-10'>
                            <div className='flex flex-col xl:flex-row justify-evenly items-baseline'>
                                <h5 className='RobotoCondensed text-center  text-indigo-700 font-extrabold px-10 tracking-widest md:text-3xl'>Pat Nguyen</h5>
                                ...
                                <a href = "mailto: pat.nguyen@abelian.capital" className='RobotoCondensed text-center px-10'>Send Email</a>
                            </div>
